...
~~~text
 12 files changed, 393 insertions(+), 5 deletions(-)
~~~

## File Stats

~~~text
 internal/common/client/grpc.go                     |  20 +++
 internal/payment/adapters/order_grpc.go            |  22 +++
 internal/payment/app/app.go                        |  11 ++
 internal/payment/app/command/create_payment.go     |  51 +++++++
 internal/payment/app/command/service.go            |  11 ++
 internal/payment/domain/payment.go                 |  11 ++
 internal/payment/go.mod                            |  14 +-
 internal/payment/go.sum                            | 162 +++++++++++++++++++++
 .../payment/infrastructure/consumer/consumer.go    |  31 +++-
 internal/payment/infrastructure/processor/inmem.go |  18 +++
 internal/payment/main.go                           |  11 +-
 internal/payment/service/application.go            |  36 +++++
 12 files changed, 393 insertions(+), 5 deletions(-)
~~~
...
internal/payment/app/app.go
internal/payment/app/command/create_payment.go
internal/payment/app/command/service.go
...
@@ -30,6 +31,25 @@ func NewStockGRPCClient(ctx context.Context) (client stockpb.StockServiceClient,
...
+	return err
+}
diff --git a/internal/payment/app/app.go b/internal/payment/app/app.go
new file mode 100644
index 0000000..915fd40
--- /dev/null
+++ b/internal/payment/app/app.go
@@ -0,0 +1,11 @@
+package app
+
...
+	)
+}
diff --git a/internal/payment/app/command/service.go b/internal/payment/app/command/service.go
new file mode 100644
index 0000000..ae7ff85
--- /dev/null
+++ b/internal/payment/app/command/service.go
@@ -0,0 +1,11 @@
+package command
+
+import (
...
index 3d977b2..cceef38 100644
--- a/internal/payment/go.mod
+++ b/internal/payment/go.mod
@@ -6,7 +6,9 @@ replace github.com/ghost-yu/go_shop_second/common => ../common
...
@@ -22,6 +40,11 @@ github.com/envoyproxy/go-control-plane v0.9.0/go.mod h1:YTl/9mNaCwkRvm6d1a2C3ymF
...
@@ -33,7 +56,11 @@ github.com/gin-contrib/sse v0.1.0 h1:Y/yl/+YNO8GZSjAhjMsSuLt29uWRFHdHYUb5lYOV9qE
...
@@ -46,27 +73,81 @@ github.com/go-playground/validator/v10 v10.14.1/go.mod h1:9iXMNT7sEkjXb0I+enO7QX
...
@@ -74,6 +155,7 @@ github.com/klauspost/cpuid/v2 v2.2.5 h1:0E5MSMDEoAulmXNFquVs//DdoomxaoTY1kUhbc/q
...
@@ -85,20 +167,41 @@ github.com/leodido/go-urn v1.2.4 h1:XlAE/cm/ms7TE/VMVoduSpNBoyc2dOxHs5MZSwAN63Q=
...
@@ -106,21 +209,44 @@ github.com/onsi/ginkgo v1.16.5/go.mod h1:+E8gABHa3K6zRBolWtd+ROzc/U5bkGt0FwiG042
...
@@ -138,12 +264,14 @@ github.com/stretchr/objx v0.1.0/go.mod h1:HFkY916IF+rwdDfMAkV7OtwuqBVzrE8GR6GFx+
...
@@ -152,6 +280,7 @@ github.com/stretchr/testify v1.9.0 h1:HtqpIVDClZ4nwg75+f6Lvsy/wHu+3BoSGCbBAcpTsT
...
@@ -173,7 +302,9 @@ go.uber.org/zap v1.18.1/go.mod h1:xg/QME4nWcxGxrpdeYfq7UvYrLh66cuVKdrbD1XF/NI=
...
@@ -189,37 +320,63 @@ golang.org/x/mod v0.2.0/go.mod h1:s0Qsj1ACt9ePp/hMypM3fl4fZqREWJwdYDEqhRiZZUA=
...
@@ -227,6 +384,7 @@ golang.org/x/tools v0.0.0-20190114222345-bf090417da8b/go.mod h1:n7NCudcB/nEzxVGm
...
@@ -253,6 +411,7 @@ google.golang.org/protobuf v1.26.0-rc.1/go.mod h1:jlhhOSvTdKEhbULTjvd4ARK9grFBp0
...
@@ -261,7 +420,10 @@ gopkg.in/ini.v1 v1.67.0 h1:Dgnx+6+nfE+IfzjUEISNeydPJh9AXNNsWbGP9KzCsOA=
...
@@ -34,5 +44,20 @@ func (c *Consumer) Listen(ch *amqp.Channel) {

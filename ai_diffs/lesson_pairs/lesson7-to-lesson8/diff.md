...
~~~text
 18 files changed, 476 insertions(+), 38 deletions(-)
~~~
...
~~~text
 ...
 internal/order/adapters/order_inmem_repository.go | 23 +++++---
 internal/order/app/app.go                         | 14 ++++-
 ...
 internal/order/http.go                            | 36 +++++++++++--
 internal/order/main.go                            |  3 +-
 internal/order/service/application.go             | 33 +++++++++++-
...
~~~text
> 78d6465 order->stock grpc
> 606345b order create and update
> 7881a0b first Query
~~~
